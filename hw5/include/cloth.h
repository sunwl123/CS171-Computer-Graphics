...
extern std::shared_ptr<RectCloth> cloth;
...
class RectCloth : public Mesh {
 public:
  ...
  void set_sphere_intersect(Vec3 center, Float r);
  ...
  bool intersect_sphere(Vec3 pos) const;
  Vec3 ComputeFluidForce(int iw, int ih, Vec3 v) const;
};
